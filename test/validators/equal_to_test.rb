...
describe ObjectSchemas::Validators::EqualTo, "initialization" do
  it "should create an instance with the provided value" do
    validator = ObjectSchemas::Validators::EqualTo.new(3)
    validator.value.must_equal 3
  end

  it "should raise an exception if a value is not provided" do
    lambda{
      ObjectSchemas::Validators::EqualTo.new
    }.must_raise ArgumentError
  end
end

describe ObjectSchemas::Validators::EqualTo, "Validation" do
  before do
    @validator = ObjectSchemas::Validators::EqualTo.new(3)
  end
...
describe ObjectSchemas::Validators::EqualTo, "error message" do
